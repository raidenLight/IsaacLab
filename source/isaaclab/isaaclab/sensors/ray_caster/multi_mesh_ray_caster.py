...
class MultiMeshRayCaster(RayCaster):
    ...
    def _update_buffers_impl(self, env_ids: Sequence[int]):
        ...
        self._data.ray_hits_w[env_ids], self._data.ray_distance[env_ids], _, _, mesh_ids = raycast_dynamic_meshes(
        ...
        self._data.ray_distance[env_ids] = self._data.ray_distance[env_ids].clip(max=self.cfg.max_distance)
